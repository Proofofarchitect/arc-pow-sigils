...
/// @notice Deploy PowMintNFTv3 ("Proof of Architect") to Arc (testnet or mainnet).
///
/// Usage:
...
///   ../tools/bin/arc-forge script script/DeployV3.s.sol --rpc-url $ARC_RPC --broadcast
///
...
///   MAX_SUPPLY (15042), ROYALTY_BPS (500), REG_WINDOW (25), PACE_TARGET_S (30)
contract DeployV3 is Script {
    function run() external returns (PowMintNFTv3 nft) {
